OC.L10N.register(
    ...
    "URL Target of the IdP where the SP will send the Authentication Request Message" : "URL-mål av IdP'n där SP'n kommer skicka meddalande om åtkomstbegäran.",
    ...
    "If you want to optionally map SAML attributes to the user you can configure these here." : "Om du vill frivilligt mappa SAML-attribut till användaren kan du konfigurera dessa här.",
