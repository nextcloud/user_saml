OC.L10N.register(
    ...
    "SAML authentication is not configured. Please ask your administrator to complete the SAML setup in the admin panel." : "Аутентификация SAML не настроена. Попросите своего администратора завершить настройку SAML в панели администратора.",
    ...
    "Service Provider Entity ID (optional)" : "Идентификатор объекта поставщика услуг (необязательно)",
    ...
    "Use POST method for SAML request (default: GET)" : "Использовать POST метод при SAML запросе (по-умолчанию: GET)",
    ...
    "Require membership in these groups, if any." : "Требуется членство в этих группах, если таковые имеются.",
    ...
    "SSO & SAML authentication" : "Аутентификация SSO и SAML",
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular account will not be possible anymore, unless you go directly to the URL {url}." : "Убедитесь, что у вас настроен пользователь с правами администратора, который может получить доступ к экземпляру через SSO. Вход в систему с вашей обычной учетной записью больше не будет возможен, пока вы не перейдёте непосредственно по URL-адресу {url}.",
    "Provider {id}" : "Поставщик {id}",
    "Could not create provider configuration" : "Не удалось создать конфигурацию поставщика",
    "Could not load provider settings" : "Не удалось загрузить настройки провайдера",
    "Saved" : "Сохранено",
    "Could not save configuration" : "Не удалось сохранить конфигурацию",
    "Unknown error (status {code})" : "Неизвестная ошибка (статус{code})",
    "Unable to update configuration" : "Невозможно обновить конфигурацию",
    "Could not add identity provider" : "Не удалось добавить поставщика удостоверений",
    "Could not remove identity provider" : "Не удалось удалить поставщика удостоверений",
    "Single sign-on and SAML authentication settings" : "Настройки единого входа и аутентификации SAML",
    ...
    "Request parameters to pass-through to IdP (comma separated list)" : "Параметры запроса для передачи IdP (список, разделенный запятыми)",
    ...
    "Signatures and encryption offered" : "Предложены подписи и шифрование",
    "Signatures and encryption required" : "Требуется подпись и шифрование",
    "User filtering" : "Фильтрация пользователей",
    ...
    "Loading…" : "Загрузка…",
    "Error" : "Ошибка",
    "Please wait while you are redirected to the SSO server." : "Пожалуйста, подождите, пока вы будете перенаправлены на  SSO сервер.",
    ...
    "Your account is denied, access to this service is thus not possible." : "Ваша учетная запись запрещена, поэтому доступ к этой услуге невозможен.",
    ...
    "Choose an authentication provider" : "Выберите службу аутентификации",
    "Group Mapping Prefix, default: SAML_" : "Префикс сопоставления групп, по умолчанию: SAML_"
},
