OC.L10N.register(
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account will not be possible anymore, unless you enabled \"%s\" or you go directly to the URL %s." : "Asegúrese de configurar un usuario administrativo que puede acceder a la instancia usando SSO. Entrar con su cuenta habitual %s no será ya posible, a no ser de que se haya habilitado \"%s\" o vaya directamente a la URL %s.",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account will not be possible anymore, unless you go directly to the URL %s." : "Asegúrese de configurar un usuario administrativo que puede acceder a la instancia usando SSO. Entrar con su cuenta habitual %s no será ya posible, a menos de que vaya directamente a la URL %s.",
    ...
    "If you want to optionally restrict user login depending on user data, configure it here." : "Si quiere de manera opcional restringir el inicio de sesión de usuarios dependiendo de sus datos, configurelos aquí.",
