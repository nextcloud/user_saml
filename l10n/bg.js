OC.L10N.register(
    ...
    "Only allow authentication if an account exists on some other backend. (e.g. LDAP)" : "Разрешаване на удостоверяване, само ако профил съществува в друг сървър. (напр. LDAP)",
