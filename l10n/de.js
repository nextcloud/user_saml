OC.L10N.register(
    ...
    "Use SAML auth for the %s desktop clients (requires user re-authentication)" : "SAML-Autorisierung für die %s Desktop-Clients nutzen (erfordert eine Neu-Autorisierung der Benutzer)",
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account will not be possible anymore, unless you enabled \"%s\" or you go directly to the URL %s." : "Es muss ein Benutzer mit Administrator-Rechten vorhanden sein, der sich mittels SSO anmelden kann. Eine Anmeldung mit deinem normalen Zugang %s ist dann nicht mehr möglich, außer du hast \"%s\" aktiviert oder du gehst Direkt zur URL %s .",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account will not be possible anymore, unless you go directly to the URL %s." : "Es muss ein Benutzer mit Administrator-Rechten vorhanden sein, der sich mittels SSO anmelden kann. Eine Anmeldung mit deinem normalen Zugang %s ist dann nicht mehr möglich, es sei denn, du gehst direkt zur URL %s.",
    ...
    "If you want to optionally restrict user login depending on user data, configure it here." : "Wenn du die Benutzeranmeldung abhängig von Benutzerdaten optional einschränken möchtest, konfiguriere dies hier.",
