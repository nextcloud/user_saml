OC.L10N.register(
    ...
    "Attribute to map the email address to." : "Atribut, na který se má mapovat emailová adresa.",
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account won't be possible anymore." : "Ujistěte se, že máte nastavený administrátorský uživatelský účet, který má přístup k instanci přes SSO. Přihlašování s klasickým %s účtem už nebude možné.",
