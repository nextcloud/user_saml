OC.L10N.register(
    ...
    "Indicates whether the <samlp:AuthnRequest> messages sent by this SP will be signed. [Metadata of the SP will offer this info]" : "ანიშნებს ამ SP-ს მეშვეობით გამოგზავნილი <samlp:AuthnRequest> ხელმოწერილ იქნება თუ არა. [ამ ინფორმაციას მოგვაწვდის SP-s მეტა მონაცემები]",
    ...
    "Indicates whether the  <samlp:logoutResponse> messages sent by this SP will be signed." : "ანიშნებს ამ SP-ს მეშვეობით გამოგზავნილი <samlp:logoutRequest> ხელმოწერილ იქნება თუ არა.",
    ...
    "Indicates a requirement for the <saml:Assertion> elements received by this SP to be signed. [Metadata of the SP will offer this info]" : "ანიშნებს მოთხოვნილებას, ამ SP-ს საშუალებით მიღებულ <saml:Assertion> ელემენტებს უნდა მოეწეროთ ხელი თუ არა. [ამ ინფორმაციას მოგვაწვდის SP-s მეტა მონაცემები]",
    "Indicates a requirement for the <saml:Assertion> elements received by this SP to be encrypted." : "ანიშნებს მოთხოვნილებას, ამ SP-ს საშუალებით მიღებულ <saml:Assertion> ელემენტები უნდა დაიშიფროს თუ არა.",
    ...
    "For increased security we recommend enabling the following settings if supported by your environment." : "გაუმჯობესებული უსაფრთხოებისთვის შესაძლებლობის შემთხვევაში რეკომენდაციას გიწევთ აამოქმედოთ შემდეგი პრამეტრები.",
