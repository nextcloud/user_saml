OC.L10N.register(
    ...
    "Service Provider Entity ID (optional)" : "ID entità fornitore di servizi (facoltativo)",
    ...
    "Attribute to map the users MFA login status" : "Attributo per mappare lo stato di accesso MFA degli utenti",
    "Group Mapping Prefix, default: %s" : "Prefisso di mappatura del gruppo, predefinito: %s",
    "Reject members of these groups. This setting has precedence over required memberships." : "Rifiuta i membri di questi gruppi. Questa impostazione ha la precedenza sulle adesioni richieste.",
    "Group A, Group B, …" : "Gruppo A, gruppo B, ...",
    "Require membership in these groups, if any." : "Richiedi l'appartenenza a questi gruppi, se presenti.",
    ...
    "Use POST method for SAML request (default: GET)" : "Utilizza il metodo POST per la richiesta SAML (predefinito: GET)",
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account will not be possible anymore, unless you enabled \"%s\" or you go directly to the URL %s." : "Assicurati di configurare un utente amministrativo che possa accedere all'istanza tramite SSO. Effettuare l'accesso con il tuo regolare %s non sarà più possibile, a meno che non lo abiliti           \"%s\" oppure vai direttamente all'URL %s.",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account will not be possible anymore, unless you go directly to the URL %s." : "Assicurati di configurare un utente amministrativo che possa accedere all'istanza tramite SSO. Effettuare l'accesso con il tuo regolare %s account non sarà più possibile, a meno che non si vada direttamente all'URL %s.",
    ...
    "General" : "Generale",
    "This feature might not work with all identity providers. Use only if your IdP specifically requires POST binding for SAML requests." : "Questa funzionalità potrebbe non essere compatibile con tutti i provider di identità. Utilizzala solo se il tuo provider di identità richiede specificamente il binding POST per le richieste SAML.",
    ...
    "Request parameters to pass-through to IdP (comma separated list)" : "Richiedi parametri da trasmettere all'IdP (elenco separato da virgole)",
    ...
    "User filtering" : "Filtraggio utente",
    "If you want to optionally restrict user login depending on user data, configure it here." : "Se si desidera limitare facoltativamente l'accesso degli utenti in base ai dati utente, è possibile configurarlo qui.",
    "Show user filtering settings …" : "Mostra impostazioni di filtraggio utente …",
    ...
    "Error" : "Errore",
    "Please wait while you are redirected to the SSO server." : "Ti preghiamo di attendere mentre verrai reindirizzato al server SSO.",
    "JavaScript is disabled in your browser. Please enable it to continue." : "JavaScript è disabilitato nel tuo browser. Abilitalo per continuare.",
    "Access denied." : "Accesso negato.",
    "Your account is denied, access to this service is thus not possible." : "Il tuo account è stato negato, pertanto l'accesso a questo servizio non è possibile.",
    ...
    "Choose an authentication provider" : "Scegli un provider di autenticazione",
    "Group Mapping Prefix, default: SAML_" : "Prefisso di mappatura del gruppo, predefinito: SAML_"
},
