OC.L10N.register(
    ...
    "This page should not be visted directly." : "Questa pagina non dovrebbe essere visitata direttamente.",
    "Provider " : "Fornitore",
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account won't be possible anymore, unless you enabled \"%s\"" : "Assicurati di configurare un utente amministrativo che possa accedere all'istanza tramite SSO. L'accesso con il tuo account normale %s non sarà più possibile a meno che tu abbia abilitato \"%s\"",
