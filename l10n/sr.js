OC.L10N.register(
    ...
    "Group Mapping Prefix, default: %s" : "Префикс мапирања групе, подразумевано: %s",
    ...
    "Use POST method for SAML request (default: GET)" : "Користи POST метод за SAML захтев (подразумевано: GET)",
    ...
    "General" : "Опште",
    "This feature might not work with all identity providers. Use only if your IdP specifically requires POST binding for SAML requests." : "Ова функција можда неће радити са свим пружаоцима услуге идентитета. Користите само ако ваш IdP за SAML захтеве изричито захтева POST везивање.",
    ...
    "Error" : "Грешка",
    "Please wait while you are redirected to the SSO server." : "Молимо вас да сачекате док се преусмеравате на SSO сервер.",
    "JavaScript is disabled in your browser. Please enable it to continue." : "У вашем прегледачу је искључен JavaScript. Да бисте наставили, молимо вас да га укључите.",
