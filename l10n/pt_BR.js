OC.L10N.register(
    ...
    "Use POST method for SAML request (default: GET)" : "Use método POST para solicitações SAML (padrão: GET)",
    ...
    "General" : "Geral",
    "This feature might not work with all identity providers. Use only if your IdP specifically requires POST binding for SAML requests." : "Esse recurso pode não funcionar com todos os provedores de identidade. Use-o somente se o seu IdP exigir especificamente a vinculação POST para solicitações SAML.",
