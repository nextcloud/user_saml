OC.L10N.register(
    ...
    "Service Provider Entity ID (optional)" : "ID de Entidade do Provedor de Serviço (opcional)",
    ...
    "Only allow authentication if an account exists on some other backend (e.g. LDAP)." : "Permitir autenticação apenas se existir uma conta em algum outro back-end (p. ex., LDAP).",
    ...
    "Use normal Nextcloud login form" : "Usar formulário normal de login do Nextcloud",
    ...
    "Reject members of these groups. This setting has precedence over required memberships." : "Rejeitar membros destes grupos. Esta configuração tem precedência sobre as associações obrigatórias.",
    "Group A, Group B, …" : "Grupo A, Grupo B, …",
    "Require membership in these groups, if any." : "Exigir associação a estes grupos, se houver.",
    ...
    "Could not create provider configuration" : "Não foi possível criar a configuração do provedor",
    ...
    "Unable to update configuration" : "Não foi possível atualizar as configurações",
    ...
    "Single sign-on and SAML authentication settings" : "Configurações de login único e autenticação SAML",
    ...
    "If you want to optionally restrict user login depending on user data, configure it here." : "Se você deseja restringir opcionalmente o login dos usuários dependendo dos dados dos usuários, configure-o aqui.",
    ...
    "Environment var starting with HTTP_ are dangerous as HTTP headers are saved in these environment variables" : "Variáveis de ambiente que começam com “HTTP_” são perigosas, pois os cabeçalhos HTTP são armazenados nessas variáveis de ambiente",
    "Attributes seen from this IdP: {attributes}" : "Atributos exibidos por este IDP: {attributes}",
    ...
    "URL Location of the IDP's SLO Response" : "Localização URL da Resposta SLO do IDP",
    ...
    "Loading…" : "Carregando…",
    "Error" : "Erro",
    "Please wait while you are redirected to the SSO server." : "Aguarde enquanto você é redirecionado para o servidor SSO.",
    "JavaScript is disabled in your browser. Please enable it to continue." : "O JavaScript está desativado em seu navegador. Ative-o para continuar.",
