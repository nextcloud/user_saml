OC.L10N.register(
    ...
    "Indicates a requirement for the <saml:Assertion> elements received by this SP to be signed. [Metadata of the SP will offer this info]" : "Indica uma solicitação para que os elementos <saml:Assertion> recebidos por este SP sejam assinados. [Metadados do SP oferecerá esta informação]",
    ...
    "Only allow authentication if an account is existent on some other backend. (e.g. LDAP)" : "Somente permite a autenticação se uma conta existir em algum outro backend. (ex. LDAP)",
    "Attribute to map the displayname to." : "Atributo para mapear o nome de exibição.",
    "Attribute to map the email address to." : "Atributo para mapear o endereço de email.",
    ...
    "Identifier of the IdP entity (must be a URI)" : "Identificador da entidade IdP (deve ser uma URL)",
