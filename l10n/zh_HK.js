OC.L10N.register(
    ...
    "Optional display name of the identity provider (default: \"SSO & SAML log in\")" : "可選的身份提供者的顯示名稱（默認：\"SSO及SAML登入\"）",
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account won't be possible anymore, unless you go directly to the URL %s." : "請確保設置一個能通過SSO訪問實例的管理員用戶。您將無法使用您的普通 %s 賬號登入，除非您直接訪問URL %s。",
