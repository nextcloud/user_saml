OC.L10N.register(
    ...
    "Indicates a requirement for the <samlp:Response>, <samlp:LogoutRequest> and <samlp:LogoutResponse> elements received by this SP to be signed." : "SP-k jasotako <samlp:Response>,<samlp:LogoutRequest>eta<samlp:LogoutResponse> elementuak sinatzeko baldintzak adierazten ditu.",
    "Indicates a requirement for the <saml:Assertion> elements received by this SP to be signed. [Metadata of the SP will offer this info]" : "SP-k jasotako <saml:Assertion>elementuak sinatzeko baldintzak adierazten ditu. [SPren metadatuek informazio hau eskainiko dute]",
    ...
    "Optional display name of the identity provider (default: \"SSO & SAML log in\")" : "Identitate hornitzailearen aukerako bistaratzeko izena (lehenetsia: \"SSO eta SAML saioa hasi\")",
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account won't be possible anymore, unless you enabled \"%s\" or you go directly to the URL %s." : "Ziurtatu SSO bidez instantziara sar daitekeen administrari erabiltzaile bat konfiguratzen duzula. Ohiko %s kontuarekin saioa hastea ezinezkoa izango da, \"%s\" gaitu edo zuzenean %sURLera joaten ez bazara.",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account won't be possible anymore, unless you go directly to the URL %s." : "Ziurtatu SSO bidez instantziara sar daitekeen administrari erabiltzaile bat konfiguratzen duzula. Zure ohiko %s kontuarekin saioa hastea ezinezkoa izango da, zuzenean %sURLera joan ezean.",
    ...
    "Name ID format" : "Izen ID formatua",
    ...
    "URL Target of the IdP where the SP will send the Authentication Request Message" : "IdPren URLaren helburua, SPk autentifikazio eskaera mezua bidaliko duenean",
