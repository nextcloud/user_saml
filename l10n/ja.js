OC.L10N.register(
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account won't be possible anymore, unless you enabled \"%s\" or you go directly to the URL %s." : "SSOを介してインスタンスにアクセスできる管理ユーザーを必ず作成してください。もう通常の%sアカウントでログインすることはできなくなります (\"%s\"を有効にしないか、直接URL %s にアクセスしない限り)。",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account won't be possible anymore, unless you go directly to the URL %s." : "SSOを介してインスタンスにアクセスできる管理ユーザーを必ず作成してください。もう通常の%sアカウントでログインすることはできなくなります (直接URL %sにアクセスしない限り)。",
