OC.L10N.register(
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account will not be possible anymore, unless you enabled \"%s\" or you go directly to the URL %s." : "インスタンスにログインできる管理ユーザーをSSO側に必ず作成してください。そうでなければ通常の%sアカウントでログインすることはできなくなります。もしくは、\"%s\"を有効にするか、直接URL %sにアクセスしてください。",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account will not be possible anymore, unless you go directly to the URL %s." : "インスタンスにアクセスできる管理ユーザーをSSO側に必ず作成してください。そうでなければ通常の%sアカウントでログインすることはできなくなります。もしくは、直接URL %sにアクセスしてください。",
    ...
    "Show user filtering settings …" : "ユーザフィルタ設定を表示 …",
