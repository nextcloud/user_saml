OC.L10N.register(
    ...
    "SAML authentication is not configured. Please ask your administrator to complete the SAML setup in the admin panel." : "L'authentification SAML n'est pas configurée. Veuillez demander à votre administrateur de terminer la configuration SAML dans le panneau d'administration.",
    "Unknown error, please check the log file for more details." : "Erreur inconnue, veuillez vérifier le fichier de log pour plus de détails.",
    ...
    "Service Provider Entity ID (optional)" : "ID de l'entité du Fournisseur de Service (SP, optionnel)",
    ...
    "Attribute to map the users to an existing LDAP user" : "Attribut pour relier des utilisateurs à un utilisateur LDAP existant",
    "Group Mapping Prefix, default: %s" : "Préfixe de mappage de groupe, par défaut: %s",
    ...
    "Using the SSO & SAML app of your Nextcloud you can make it easily possible to integrate your existing Single-Sign-On solution with Nextcloud. In addition, you can use the Nextcloud LDAP user provider to keep the convenience for users. (e.g. when sharing)\nThe following providers are supported and tested at the moment:\n\n* **SAML 2.0**\n\t* OneLogin\n\t* Shibboleth\n\t* Active Directory Federation Services (ADFS)\n\t* Authentik\n\n* **Authentication via Environment Variable**\n\t* Kerberos (mod_auth_kerb)\n\t* Any other provider that authenticates using the environment variable\n\nWhile theoretically any other authentication provider implementing either one of those standards is compatible, we like to note that they are not part of any internal test matrix." : "En utilisant l'application SSO & SAML de votre Nextcloud, vous pouvez facilement intégrer votre solution d'authentification unique dans Nextcloud. De plus, vous pouvez utiliser le fournisseur d'utilisateurs LDAP de Nextcloud pour simplifier la tâche des utilisateurs (par ex. lors des partages).\nActuellement, les fournisseurs suivants sont pris en charge et testés :\n\n* **SAML 2.0**\n\t* OneLogin\n\t* Shibboleth\n\t* Active Directory Federation Services (ADFS)\n\t* Authentik\n\n* **Authentification via des variables d'environnement**\n\t* Kerberos (mod_auth_kerb)\n\t* Tout autre fournisseur qui s'authentifie à l'aide de variables d'environnement\n\nBien qu'en théorie tout autre fournisseur d'authentification qui implémente un de ces standards soit compatible, nous tenons à souligner qu'ils ne font partie d'aucune matrice de tests interne.",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular account will not be possible anymore, unless you go directly to the URL {url}." : "Assurez-vous de configurer un utillisateur administratif pouvant accéder à l'instance via SSO. La connexion avec votre compte normal ne sera plus possible, à moins de vous rendre directement à l'URL {url}.",
    "Provider {id}" : "Fournisseur {id}",
    "Could not create provider configuration" : "Impossible de créer la configuration du fournisseur",
    "Could not load provider settings" : "Impossible de charger les paramètres du fournisseur",
    "Saved" : "Sauvegardé",
    "Could not save configuration" : "Impossible d'enregistrer la configuration",
    "Unknown error (status {code})" : "Erreur inconnue (état {code})",
    "Unable to update configuration" : "Impossible de mettre à jour la configuration",
    "Could not add identity provider" : "Impossible d'ajouter le fournisseur d'identité",
    "Could not remove identity provider" : "Impossible de supprimer le fournisseur d'identité",
    "Single sign-on and SAML authentication settings" : "Paramètres d'authentification unique et SAML",
    ...
    "Environment variable provider settings" : "Paramètres du fournisseur avec variables d'environnement",
    ...
    "Loading…" : "Chargement…",
    "Error" : "Erreur",
    "Please wait while you are redirected to the SSO server." : "Veuillez patienter pendant que vous êtes redirigé vers le serveur SSO.",
    "JavaScript is disabled in your browser. Please enable it to continue." : "JavaScript est désactivé dans votre navigateur. Veuillez l'activer pour continuer.",
    ...
    "Choose an authentication provider" : "Choisissez un fournisseur d'authentification",
    "Group Mapping Prefix, default: SAML_" : "Group Mapping Prefix, par défaut: SAML_"
},
