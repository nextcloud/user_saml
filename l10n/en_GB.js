OC.L10N.register(
    ...
    "SAML authentication is not configured. Please ask your administrator to complete the SAML setup in the admin panel." : "SAML authentication is not configured. Please ask your administrator to complete the SAML setup in the admin panel.",
    ...
    "Service Provider Entity ID (optional)" : "Service Provider Entity ID (optional)",
    ...
    "Use POST method for SAML request (default: GET)" : "Use POST method for SAML request (default: GET)",
    "Allow the use of multiple user back-ends (e.g. LDAP)" : "Allow the use of multiple user back-ends (e.g. LDAP)",
    "Use normal Nextcloud login form" : "Use normal Nextcloud login form",
    ...
    "Attribute to map the users to an existing LDAP user" : "Attribute to map the users to an existing LDAP user",
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular account will not be possible anymore, unless you go directly to the URL {url}." : "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular account will not be possible anymore, unless you go directly to the URL {url}.",
    "Provider {id}" : "Provider {id}",
    "Could not create provider configuration" : "Could not create provider configuration",
    "Could not load provider settings" : "Could not load provider settings",
    "Saved" : "Saved",
    "Could not save configuration" : "Could not save configuration",
    "Unknown error (status {code})" : "Unknown error (status {code})",
    "Unable to update configuration" : "Unable to update configuration",
    "Could not add identity provider" : "Could not add identity provider",
    "Could not remove identity provider" : "Could not remove identity provider",
    "Single sign-on and SAML authentication settings" : "Single sign-on and SAML authentication settings",
    ...
    "Environment variable provider settings" : "Environment variable provider settings",
    ...
    "Environment var starting with HTTP_ are dangerous as HTTP headers are saved in these environment variables" : "Environment var starting with HTTP_ are dangerous as HTTP headers are saved in these environment variables",
    "Attributes seen from this IdP: {attributes}" : "Attributes seen from this IdP: {attributes}",
    "This feature might not work with all identity providers. Use only if your IdP specifically requires POST binding for SAML requests." : "This feature might not work with all identity providers. Use only if your IdP specifically requires POST binding for SAML requests.",
    ...
    "Request parameters to pass-through to IdP (comma separated list)" : "Request parameters to pass-through to IdP (comma separated list)",
