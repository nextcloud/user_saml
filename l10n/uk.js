OC.L10N.register(
    ...
    "Use SAML auth for the %s desktop clients (requires user re-authentication)" : "Використовуйте автентифікацію SAML для %s стільничих клієнтів (потрібна повторна автентифікація користувача)",
