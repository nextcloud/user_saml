OC.L10N.register(
    ...
    "Algorithm that the toolkit will use on signing process." : "서명 작업에서 사용될 툴킷 알고리즘",
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account will not be possible anymore, unless you enabled \"%s\" or you go directly to the URL %s." : "인스턴스에 SSO로 접근할 수 있는 관리 사용자를 설정하십시오. 더 이상 일반 %s 계정으로 로그인할 수 없습니다. 일반 계정으로 로그인하려면 \"%s\"을(를) 활성화하거나 %s URL을 직접 방문해야 합니다.",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account will not be possible anymore, unless you go directly to the URL %s." : "인스턴스에 SSO로 접근할 수 있는 관리자 계정을 설정하십시오. 더 이상 일반 %s 계정으로 로그인할 수 없습니다. 일반 계정으로 로그인하려면 %s URL을 직접 방문해야 합니다.",
    ...
    "URL Location of the IDP's SLO Response" : "IDP의 SLO 응답에 대한 URL",
    ...
    "User filtering" : "사용자 필터링",
    "Show user filtering settings …" : "사용자 필터링 설정 표시 ...",
    ...
    "Your account is denied, access to this service is thus not possible." : "계정이 거부되었습니다. 이 서비스에 접근할 수 없습니다.",
