OC.L10N.register(
    ...
    "Indicates whether the <samlp:AuthnRequest> messages sent by this SP will be signed. [Metadata of the SP will offer this info]" : "Indica se as mensaxes <samlp:AuthnRequest> enviados por este SP van seren asinados. [Os metadatos do SP ofrecerán esta información]",
    "Indicates whether the  <samlp:logoutRequest> messages sent by this SP will be signed." : "Indica se as mensaxes <samlp:logoutRequest> enviados por este SP van seren asinados.",
    "Indicates whether the  <samlp:logoutResponse> messages sent by this SP will be signed." : "Indica se as mensaxes <samlp:logoutResponse> enviados por este SP van seren asinados.",
    ...
    "Attribute to map the email address to." : "Atributo para asignar o enderezo de correo que amosar a",
    ...
    "Show attribute mapping settings ..." : "Amosar os axustes dos atributos asignados ...",
    ...
    "Show security settings ..." : "Amosar os axustes de seguridade ...",
