OC.L10N.register(
    ...
    "Attribute to map the UID to." : "Atributo para asignar ao UID.",
    ...
    "Attribute to map the displayname to." : "Atributo ao que asignar o nome a amosar.",
    "Attribute to map the email address to." : "Atributo ao que asignar o enderezo de correo.",
    "Use SAML auth for the %s desktop clients (requires user re-authentication)" : "Usar autenticación SAML para os clientes de escritorio %s (necesita unha re-autenticación do usuario)",
    ...
    "Please choose whether you want to authenticate using the SAML provider built-in in Nextcloud or whether you want to authenticate against an environment variable." : "Por favor escolla se quere autenticarse usando o provedor SAML integrado en Nextcloud ou se quere autenticarse cunha variábel de entorno.",
    "Use built-in SAML authentication" : "Usar a autenticación integrada de SAML",
    "Use environment variable" : "Usar variábel de entorno",
    "General" : "Xeral",
    "Service Provider Data" : "Datos do provedor do servizo",
    ...
    "Identity Provider Data" : "Datos do Provedor de Identidade",
    "Configure your IdP settings here." : "Configure os axustes do seu IdP aquí.",
    "Identifier of the IdP entity (must be a URI)" : "Identificador da entidade IdP (ten que ser unha URI)",
