OC.L10N.register(
    ...
    "Use SAML auth for the %s desktop clients (requires user re-authentication)" : "Usar a autenticación SAML para os clientes de escritorio %s (precisa unha nova autenticación do usuario)",
