OC.L10N.register(
    ...
    "Only allow authentication if an account exists on some other backend. (e.g. LDAP)" : "Permiti s'autenticatzione isceti si unu contu esistit in carchi àteru motore (es. LDAP)",
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account won't be possible anymore, unless you enabled \"%s\" or you go directly to the URL %s." : "Assegura·ti de cunfigurare un'utèntzia amministrativa chi podet intrare in s'istàntzia tràmite SSO. A intrare cun su contu tuo %s no at a fàghere prus, a no èssere chi as ativadu \"%s\" o chi andas diretamente a s'URL %s.",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account won't be possible anymore, unless you go directly to the URL %s." : "Assegura·ti de cunfigurare un'utèntzia amministrativa chi potzat intrare in s'istàntzia tràmite SSO. A intrare cun su contu tuo %s no at a fàghere prus, a no èssere chi andas diretamente a s'URL %s.",
    ...
    "Show Service Provider settings…" : "Mustra impostatziones frunidore de servìtzios...",
    "Name ID format" : "Formadu nùmene ID",
    "Identity Provider Data" : "Datos de su funidore de identidade",
    "Configure your IdP settings here." : "Cunfigura inoghe is impostatziones IdP tuas.\\",
    ...
    "Show optional Identity Provider settings…" : "Mustra impostatziones a praghere de su frunidore de identidade...",
    ...
    "Show attribute mapping settings…" : "Mustra is impostatziones de assòtziu de is atributos...",
    "Security settings" : "Impostatziones de seguridade",
    "For increased security we recommend enabling the following settings if supported by your environment." : "Pro una seguresa majore, cussigiamus de ativare is impostatziones in fatu, si sunt suportadas dae s'ambiente tuo.",
    "Show security settings…" : "Mustra impostatziones de seguridade...",
    ...
    "Reset settings" : "Riprìstina impostatziones",
