OC.L10N.register(
    ...
    "Using the SSO & SAML app of your Nextcloud you can make it easily possible to integrate your existing Single-Sign-On solution with Nextcloud. In addition, you can use the Nextcloud LDAP user provider to keep the convenience for users. (e.g. when sharing)\nThe following providers are supported and tested at the moment:\n\n* **SAML 2.0**\n\t* OneLogin\n\t* Shibboleth\n\t* Active Directory Federation Services (ADFS)\n\n* **Authentication via Environment Variable**\n\t* Kerberos (mod_auth_kerb)\n\t* Any other provider that authenticates using the environment variable\n\nWhile theoretically any other authentication provider implementing either one of those standards is compatible, we like to note that they are not part of any internal test matrix." : "Usando la aplicación SSO y SAML de Nextcloud, puedes integrar fácilmente tu solución de Inicio de Sesión Único existente con Nextcloud. Además, puedes usar el proveedor de usuarios LDAP de Nextcloud para mantener la comodidad para los usuarios (por ejemplo, al compartir archivos).\nLos siguientes proveedores son compatibles y se han probado actualmente:\n\n* **SAML 2.0**\n\t* OneLogin\n\t* Shibboleth\n\t* Servicios de Federación de Active Directory (ADFS)\n\n* **Autenticación a través de variable de entorno**\n\t* Kerberos (mod_auth_kerb)\n\t* Cualquier otro proveedor que autentique mediante la variable de entorno\n\nAunque teóricamente cualquier otro proveedor de autenticación que implemente uno de estos estándares es compatible, queremos señalar que no forman parte de ninguna matriz de pruebas interna.",
    "Open documentation" : "Abrir documentación",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account will not be possible anymore, unless you enabled \"%s\" or you go directly to the URL %s." : "Asegúrate de configurar un usuario administrativo que pueda acceder a la instancia a través de SSO. Iniciar sesión con tu cuenta regular de %s ya no será posible, a menos que habilites \"%s\" o vayas directamente a la URL %s.",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account will not be possible anymore, unless you go directly to the URL %s." : "Asegúrate de configurar un usuario administrativo que pueda acceder a la instancia a través de SSO. Iniciar sesión con tu cuenta regular de %s ya no será posible, a menos que vayas directamente a la URL %s.",
    ...
    "Add identity provider" : "Agregar proveedor de identidad",
    "General" : "General",
