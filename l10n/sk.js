OC.L10N.register(
    ...
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account won't be possible anymore, unless you enabled \"%s\" or you go directly to the URL %s." : "Nezabudnite nastaviť používateľa-správcu, ktorý má prístup k inštancii prostredníctvom SSO. Prihlásenie pomocou bežného účtu %s už nebude možné, pokiaľ nepovolíte „%s“ alebo nezačnete priamo na URL %s.",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular %s account won't be possible anymore, unless you go directly to the URL %s." : "Nezabudnite nastaviť používateľa-správcu, ktorý má prístup k inštancii prostredníctvom SSO. Prihlásenie pomocou bežného účtu %s už nebude možné, jedine ak začnete priamo na URL %s.",
