OC.L10N.register(
    ...
    "SAML authentication is not configured. Please ask your administrator to complete the SAML setup in the admin panel." : "SAML kimlik doğrulaması yapılandırılmamış. Lütfen yöneticinizden yönetici panosundan SAML kurulumunu tamamlamasını isteyin.",
    ...
    "Provider %s" : "%s hizmet sağlayıcısı",
    ...
    "Use normal Nextcloud login form" : "Normal Nextcloud oturum açma formu kullanılsın",
    ...
    "Attribute to map the users to an existing LDAP user" : "Kullanıcıları var olan bir LDAP kullanıcısı ile eşleştirmek için kullanılacak öznitelik",
    ...
    "Using the SSO & SAML app of your Nextcloud you can make it easily possible to integrate your existing Single-Sign-On solution with Nextcloud. In addition, you can use the Nextcloud LDAP user provider to keep the convenience for users. (e.g. when sharing)\nThe following providers are supported and tested at the moment:\n\n* **SAML 2.0**\n\t* OneLogin\n\t* Shibboleth\n\t* Active Directory Federation Services (ADFS)\n\t* Authentik\n\n* **Authentication via Environment Variable**\n\t* Kerberos (mod_auth_kerb)\n\t* Any other provider that authenticates using the environment variable\n\nWhile theoretically any other authentication provider implementing either one of those standards is compatible, we like to note that they are not part of any internal test matrix." : "Tek Oturum Açma ve SAML uygulaması var olan Tek Oturum Açma uygulamanız ile Nextcloud sunucunuzun bütünleşik çalışmasını sağlar. Ek olarak Kullanıcılarınıza kolaylık sağlamak için (paylaşım sırasında gibi) LDAP kullanıcı hizmeti sağlayıcısını da kullanabilirsiniz.\nŞu anda aşağıdaki hizmet sağlayıcılar denenmiş ve destekleniyor:\n\n* **SAML 2.0**\n\t* OneLogin\n\t* Shibboleth\n\t* Active Directory Federation Services (ADFS)\n\t* Authentik\n\n* **Authentication via Environment Variable**\n\t* Kerberos (mod_auth_kerb)\n\t* Kimlik doğrulamasında ortam değişkeni kullanan diğer hizmet sağlayıcılar\n\nTeorik olarak bu standartlara uygun diğer hizmet sağlayıcıların da uyumlu olması gerekir. Denememizi istediğiniz diğer uygulamaları bize bildirirseniz seviniriz.",
    "Make sure to configure an administrative user that can access the instance via SSO. Logging-in with your regular account will not be possible anymore, unless you go directly to the URL {url}." : "Kopyaya tek oturum açma üzerinden erişebilecek bir yönetici kullanıcı yapılandırdığınızdan emin olun. Bundan sonra normal hesabınızı kullanarak oturum açabilmeniz için doğrudan {url} adresine gitmeniz gerekir.",
    "Provider {id}" : "{id} hizmet sağlayıcısı",
    "Could not create provider configuration" : "Hizmet sağlayıcı yapılandırması oluşturulamadı",
    "Could not load provider settings" : "Hizmet sağlayıcı ayarları yüklenemedi",
    "Saved" : "Kaydedildi",
    "Could not save configuration" : "Yapılandırma kaydedilemedi",
    "Unknown error (status {code})" : "Bilinmeyen sorun (durum {code})",
    "Unable to update configuration" : "Yapılandırma güncellenemedi",
    "Could not add identity provider" : "Kimlik hizmeti sağlayıcısı eklenemedi",
    "Could not remove identity provider" : "Kimlik hizmeti sağlayıcısı kaldırılamadı",
    "Single sign-on and SAML authentication settings" : "Tek oturum açma ve SAML kimlik doğrulama ayarları",
    ...
    "Environment var starting with HTTP_ are dangerous as HTTP headers are saved in these environment variables" : "HTTP üst bilgileri bu ortam değişkenlerine kaydedildiği için HTTP_ ile başlayan ortam değişkenleri tehlikelidir",
    "Attributes seen from this IdP: {attributes}" : "Bu kimlik hizmeti sağlayıcısından görülebilen öznitelikler: {attributes}",
    ...
    "Loading…" : "Yükleniyor…",
    "Error" : "Hata",
    "Please wait while you are redirected to the SSO server." : "Tek oturum açma sunucusuna yönlendiriliyor. Lütfen bekleyin.",
