OC.L10N.register(
    ...
    "Allow the use of multiple user back-ends (e.g. LDAP)" : "السماح باستخدام واجهات مستخدم متعددة (على سبيل المثال خادم بروتوكول LDAP)",
    ...
    "Request parameters to pass-through to IdP (comma separated list)" : "طلب البارامترات التي سيتم تمريرها إلى موفر الهوية (في شكل قائمة مفصولة بفواصل)",
    "Attribute mapping" : "تعيين السمة",
    "If you want to optionally map attributes to the user you can configure these here." : "إذا كنت تريد تعيين الخصائص بشكل اختياري للمستخدم ، فيمكنك تكوينها هنا.",
    "Show attribute mapping settings…" : "عرض إعدادات تعيين الخصائص...",
    ...
    "Signatures and encryption offered" : "التوقيعات والتشفير المقدم",
    "Signatures and encryption required" : "مطلوب التوقيعات والتشفير",
    "User filtering" : "تصفية المستخدمين",
    ...
    "Show user filtering settings …" : "عرض إعدادات تصفية المستخدمين ...",
