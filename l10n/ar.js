OC.L10N.register(
    ...
    "SSO & SAML log in" : "تسجيل الدخول عبر تسجيل الدخول الأحادي \"SSO \"ومصادقة لغة توصيف تأكيد الأمان \"SAML\" ",
    ...
    "Only allow authentication if an account exists on some other backend (e.g. LDAP)." : "السماح بالمصادقة فقط إذا كان الحساب موجودًا على بعض الواجهات الخلفية الأخرى (مثل LDAP).",
    ...
    "Use SAML auth for the %s desktop clients (requires user re-authentication)" : "استخدام مصادقة لغة توصيف تأكيد الأمان \"SAML\" لـ%sعملاء سطح المكتب (تتطلب إعادة مصادقة المستخدم)",
    ...
    "Allow the use of multiple user back-ends (e.g. LDAP)" : "السماح باستخدام واجهات مستخدم متعددة (على سبيل المثال خادوم بروتوكول الوصول إلي الدليل البسيط \"LDAP\")",
    "SSO & SAML authentication" : "المصادقة عبر SSO و SAML",
    "Authenticate using single sign-on" : "المصادقة باستخدام تسجيل الدخول الأحادي",
    "Using the SSO & SAML app of your Nextcloud you can make it easily possible to integrate your existing Single-Sign-On solution with Nextcloud. In addition, you can use the Nextcloud LDAP user provider to keep the convenience for users. (e.g. when sharing)\nThe following providers are supported and tested at the moment:\n\n* **SAML 2.0**\n\t* OneLogin\n\t* Shibboleth\n\t* Active Directory Federation Services (ADFS)\n\n* **Authentication via Environment Variable**\n\t* Kerberos (mod_auth_kerb)\n\t* Any other provider that authenticates using the environment variable\n\nWhile theoretically any other authentication provider implementing either one of those standards is compatible, we like to note that they are not part of any internal test matrix." : "باستخدام تطبيق لغة توصيف تأكيد الأمان \"SAML\" وتسجيل الدخول الأحادي \"SSO\" في نكست كلود، يمكنك بسهولة دمج حل تسجيل الدخول الأحادي الحالي مع نكست كلود. بالإضافة إلى ذلك، يمكنك استخدام مزود مستخدم خادوم بروتوكول الوصول إلي الدليل البسيط لنكست كلود \"Nextcloud LDAP\" للحفاظ على الملائمة والراحة للمستخدمين. (على سبيل المثال، أثناء المشاركة) \nيتم دعم واختبار مزودي الخدمات التاليين في الوقت الحالي:\n\n* ** SAML 2.0 **\n\t * OneLogin\n\t * Shibboleth\n\t * خدمات جهات الاتصال الخارجية للدليل النشط (ADFS)\n\n* ** المصادقة من خلال متغير البيئة **\n\t * Kerberos (mod_auth_kerb)\n\t * أي مزود آخر يقوم بالمصادقة باستخدام متغير البيئة\n\nوبالرغم من أنه من الناحية النظرية يكون أي مزود مصادقة آخر يطبق أيًا من هذين المعيارين متوافق، إلا أنه تجدر الإشارة إلي أنهما ليسا جزءًا من أي مصفوفة اختبار داخلية.",
    ...
    "Use built-in SAML authentication" : "استخدام مصادقة لغة توصيف تأكيد الأمان \"SAML\" المدمجة",
