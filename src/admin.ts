...
import type { GlobalConfig, KnownAttributesMap, NameIdFormatsMap, Provider, SecurityGeneralMap, SecurityMap, SettingsMap } from './types.ts'
...
const app = createApp(AdminSettings, {
	...
	initialKnownAttributes: loadState<KnownAttributesMap>('user_saml', 'knownAttributes', {}),
