...
* This repository ([User SAML](https://github.com/nextcloud/user_saml/issues)) is *only* for issues within the User SAML code.
...
[template]: https://raw.github.com/nextcloud/user_saml/master/.github/issue_template.md
